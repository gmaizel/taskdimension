...
function Confirm(message, buttons, callback)
{
	...
	this._dialogContainer.appendChild(this._dialogBox);
...
Confirm.prototype._show = function()
{
	...
	this._dialogBox.style.left = ((this._dialogContainer.offsetWidth - this._dialogBox.offsetWidth) / 2) | 0;
	this._dialogBox.style.top = ((this._dialogContainer.offsetHeight - this._dialogBox.offsetHeight) / 2) | 0;
